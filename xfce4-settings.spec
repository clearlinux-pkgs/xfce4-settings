...
Source0  : https://archive.xfce.org/src/xfce/xfce4-settings/4.18/xfce4-settings-4.18.1.tar.bz2
...
%prep
%setup -q -n xfce4-settings-4.18.1
cd %{_builddir}/xfce4-settings-4.18.1
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673459375
