...
Version  : 4.18.0
Release  : 40
URL      : https://archive.xfce.org/src/xfce/xfce4-settings/4.18/xfce4-settings-4.18.0.tar.bz2
Source0  : https://archive.xfce.org/src/xfce/xfce4-settings/4.18/xfce4-settings-4.18.0.tar.bz2
...
%prep
%setup -q -n xfce4-settings-4.18.0
cd %{_builddir}/xfce4-settings-4.18.0
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671135770
...
cp %{_builddir}/xfce4-settings-%{version}/COPYING %{buildroot}/usr/share/package-licenses/xfce4-settings/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
...
/usr/share/xfce4/helpers/alacritty.desktop
...
/usr/share/xfce4/helpers/kitty.desktop
...
/usr/share/package-licenses/xfce4-settings/4cc77b90af91e615a64ae04893fdffa7939db84c
