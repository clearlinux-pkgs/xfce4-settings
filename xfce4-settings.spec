...
Source0  : http://archive.xfce.org/src/xfce/xfce4-settings/4.13/xfce4-settings-4.13.7.tar.bz2
...
%prep
%setup -q -n xfce4-settings-4.13.7
%patch1 -p1
%patch2 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1562016872
...
/usr/share/package-licenses/xfce4-settings/COPYING
