...
Source0  : http://archive.xfce.org/src/xfce/xfce4-settings/4.14/xfce4-settings-4.14.0.tar.bz2
...
%prep
%setup -q -n xfce4-settings-4.14.0
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565572828
