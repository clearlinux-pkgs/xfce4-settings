...
Source0  : https://archive.xfce.org/src/xfce/xfce4-settings/4.16/xfce4-settings-4.16.2.tar.bz2
...
%prep
%setup -q -n xfce4-settings-4.16.2
cd %{_builddir}/xfce4-settings-4.16.2
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624758132
...
cp %{_builddir}/xfce4-settings-4.16.2/COPYING %{buildroot}/usr/share/package-licenses/xfce4-settings/dfac199a7539a404407098a2541b9482279f690d
%make_install
